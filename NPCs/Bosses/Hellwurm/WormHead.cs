...
namespace InitiateMod.NPCs.Bosses.Hellwurm
{
    public class WormHead : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Hellwurm");
        }

        public override void SetDefaults()
        {
            
            npc.lifeMax = 30000;        //this is the npc health
	...
	if (Main.expertMode)
	{
    Item.NewItem(npc.getRect(), mod.ItemType("HellwurmBag"));        
	}
	else
	{
	Item.NewItem(npc.getRect(), ItemID.LivingFireBlock, 20);
	}
	}
